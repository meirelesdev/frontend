...
export default () => {
    return (
        <footer className={styles.fundogray}>
                    ...
                    <div className={styles["navinferior"]}>
                        ...
                        <ul className={styles["listalinks"]}>
                            <li>
                                <Link href="/" >
                                    <a>
                                    <img src="assets/icon/seta.svg" id={styles.iconseta} />Home</a>
                                </Link>
                            </li>
                            <li>
                                <Link href="/sobrenos" >
                                    <a>
                                    <img src="assets/icon/seta.svg" id={styles.iconseta} />Sobre nós</a>
                                </Link>
                            </li>
                            <li>
                                <Link href="/gallery" >
                                    <a>
                                    <img src="assets/icon/seta.svg" id={styles.iconseta} />Galeria</a>
                                </Link>
                            </li>
                            <li>
                                <Link href="/planos" >
                                    <a>
                                    <img src="assets/icon/seta.svg" id={styles.iconseta} />Planos</a>
                                </Link>
                            </li>
                            <li>
                                <Link href="/blog" >
                                    <a>
                                    <img src="assets/icon/seta.svg" id={styles.iconseta} />blog</a>
                                </Link>
                            </li>
                            <li>
                                <Link href="/contact" >
                                    <a>
                                    <img src="assets/icon/seta.svg" id={styles.iconseta} />Contato</a>
                                </Link>
                            </li>
                        </ul>
                    </div>
